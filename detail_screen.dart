...
// ── YouTube embed via webview_flutter ────────────────────────────────────────
// Nếu chưa có package, dùng placeholder đẹp thay thế
class _YoutubeEmbed extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Sử dụng url_launcher để mở YouTube nếu không có webview
    return Container(
color: Colors.black,
      child: Center(
        child: Column(
          ...
          children: [
            ...
            ElevatedButton.icon(
              onPressed: () {
                // url_launcher: launchUrl(Uri.parse('https://youtube.com/watch?v=$videoKey'))
              },
              icon: const Icon(Icons.open_in_new),
              label: Text('youtube.com/watch?v=$videoKey'),
